...
+ European Centre for Diesease Prevention and Control (ECDPC). https://www.ecdc.europa.eu/en    
...
```{r , echo=FALSE}
p1 = ggplot(data=subset(d3,dataSource=='ECDPC'),
       aes(x=daysIn, 
           y=cases_rolling, 
           colour=country)) +
  geom_point(na.rm=T) + 
...
p2=ggplot(data=subset(d3,dataSource=='ECDPC'),
       aes(x=daysIn, 
           y=deaths_rolling, 
           colour=country)) +
  geom_point(na.rm=T) + 
...
```{r message=FALSE, echo=FALSE}
p3 = ggplot(data=subset(d3,dataSource=='ECDPC'),
...
```{r message=FALSE, echo=FALSE}
p4 = ggplot(data=subset(d3,dataSource=='ECDPC'),
